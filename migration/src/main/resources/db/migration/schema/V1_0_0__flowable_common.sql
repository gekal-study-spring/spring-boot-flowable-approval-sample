-- ============================================================
-- Flowable 共通テーブル (ACT_GE_*, FLW_RU_BATCH*)
-- 出典: flowable-engine-common-8.0.0.jar の org/flowable/common/db/create/flowable.postgres.create.common.sql をそのまま取り込んだもの。
-- Flowable を上げるときは、対応バージョンの upgrade スクリプトを新しい V ファイルとして追加する。
-- ============================================================
