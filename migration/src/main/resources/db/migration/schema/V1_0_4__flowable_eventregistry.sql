-- ============================================================
-- Flowable イベントレジストリテーブル (FLW_EVENT_*, FLW_CHANNEL_DEFINITION)
-- 出典: flowable-event-registry-8.0.0.jar の org/flowable/eventregistry/db/create/flowable.postgres.create.eventregistry.sql をそのまま取り込んだもの。
